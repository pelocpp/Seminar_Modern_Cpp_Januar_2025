...
namespace Auto_Examples {
    ...
    void test_TueWas()
    {
        auto result1 = tueWas2(true, 123.0f, 456.0f);
        auto result2 = tueWas2(true, 123ll, 456ll);
    }
    ...
    // In den meisten Fällen (80):
    // Liefert eine Funktion einen WERT oder eine REFERENZ zurück ? WERT

    static const std::string tueNochWas()
    {
        std::string a = "ABC";
